...
void test_static_map()
{
    ...
    constexpr auto vv = semi::detail::constexpr_strlen("helloworld");
    ...
    // Test compile-time only load/store
    {
        ...
        constexpr auto ss1 = sizeof(std::string);
...
int main()
{
    ...
    auto& food1 = map::get(ID("food"),"aa1");
    auto& food2 = map::get(ID("food"), "aa2");
    auto& food3 = map::get(ID("food"), "aa3");
    auto& food4 = map::get(ID("food"), "aa4");
    auto& food5 = map::get(ID("food"), "aa5");
